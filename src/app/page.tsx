...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#0c0c0f]">
      ...
      {/* Hero */}
      <section className="relative text-center px-7 pt-[58px] pb-11 overflow-hidden">
        ...
        <div className="relative z-10">
          ...
          <p className="text-[14px] text-white/45 max-w-[420px] mx-auto mb-5 leading-[1.75] relative z-10">
      ...
      <section className="px-6 py-8 relative overflow-hidden" style={{background:"#0a0f0d",borderTop:"0.5px solid rgba(93,202,165,0.12)",borderBottom:"0.5px solid rgba(93,202,165,0.12)"}}>
      ...
      {/* Why it works */}
      <section id="how-it-works" className="px-6 pt-7 pb-9 border-t border-white/[0.06] bg-[#0e0e12]">
