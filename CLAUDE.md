...
3. `feature/pptx-converter` — PPTX support + slide count
4. `feature/converter-ui` — split pane, format toggle, copy button
5. `feature/merge-files` — multi-file upload + merge output
6. `feature/highlight-extractor` — extract annotated/highlighted text from PDFs
